        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 d-flex flex-row align-items-center">
                    ...
                    <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="{{route('web.home')}}#feedback-form">Murojat qoldirish</a>
                </div>
            </div>
        </div>
    </div><!-- top_bar end-->
                        ...
                        <div class="site-navigation d-flex flex-row">
                            ...
                            <nav class="main-menu menu-mobile" id="menu">
                                <ul class="menu">
                                    ...
                                    <li class="@if(request()->routeIs('web.courses.*')) active @endif"><a href="{{route('web.courses.index')}}">Kasbga o'qitiladigan yo'nalishlar</a></li>
                                    <li><a href="#">Kerakli Hujjatlar</a></li>
                                    <li><a href="#">Foto va video galeriya</a></li>
                                    <li class="@if(request()->routeIs('web.blog.*')) active @endif"><a href="{{route('web.blog.index')}}">Yangiliklar</a></li>
