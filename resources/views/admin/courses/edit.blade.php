...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <form action="{{ route('courses.update', $item->id) }}" method="POST" class="card mb-3" enctype="multipart/form-data" autocomplete="off">
                @csrf @method('PATCH')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="mb-3">
                                <div class="form-label">Kurs uchun yangi rasm tanlash</div>
            ...
            <form action="{{ route('courses.update', $item->id) }}" method="POST" class="card mb-3" autocomplete="off">
                @csrf @method('PATCH')
                <div class="card-body">

                    <div class="mb-3">
                        <label class="form-label required">Kurs nomi - {{$data['native']}}</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label required">Kurs haqida to'liq ma'lumot - {{$data['native']}}</label>
